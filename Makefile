...
bin/test: build/ygad_test.o build/100_test.o build/Moneta_test.o build/main.o src/ygad.h src/Moneta.h src/100.h bin/libIgro.so
	gcc -Wall build/ygad_test.o build/100_test.o build/Moneta_test.o build/main.o bin/libIgro.so -o bin/test -Isrc -Ithirdparty 

test: bin/test
	bin/test	

bin/menu: menu.c src/ygad.c src/100.c src/Moneta.c
